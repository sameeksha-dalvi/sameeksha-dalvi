...
* **Mozilla Firefox** — Contributed to frontend improvements:
  ...
  - Added ARIA state (aria-expanded) to the Customize button, enabling assistive technologies to accurately detect its expanded/collapsed state. ([D294100](https://phabricator.services.mozilla.com/D294100))
...
### Connect with me
  [Twitter](https://x.com/sameekshadalvi7)  | [Blog](https://medium.com/@sameekshadalvi7)
